pipeline {
    ...
    environment {
        ...
        // ============================================================
        // JAVA / MAVEN
        JAVA_HOME = 'C:\\Program Files\\Java\\jdk-17.0.2e'
        MAVEN_HOME = 'D:\\apache-maven-3.8.5'

        // BACKEND
        APP_JAR = 'target/quizapp-1.0.0.jar'
        BACKEND_PORT = '8080'
        ...
        PLAYWRIGHT_DIR = 'C:\Users\Kavi.bharathi\Downloads\quiz-app-backend (1)\quiz-app\src\test\java'
